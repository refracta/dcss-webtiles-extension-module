...
(function () {
    ...
    (async () => {
        ...
        localStorage.DWEM_MODULES = JSON.stringify([
            ...
            ...['io-hook', 'site-information', 'websocket-factory', 'rc-manager', 'module-manager', 'command-manager', 'sound-support', 'convenience-module', 'advanced-rc-editor', 'translation-module', 'wtrec', 'map-predictor']
