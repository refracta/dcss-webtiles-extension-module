export default class SpectatorModule {
    ...
    onLoad() {
        ...
        IOHook.handle_message.after.addHandler('spectator-module', (data) => {
            ...
            if (data.msg === 'msgs' && data.messages && data.messages.length && util) {
                msgBar.innerHTML = util.formatted_string_to_html(data.messages[data.messages.length - 1].text);
            }
