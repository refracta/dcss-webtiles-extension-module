export default class SpectatorModule {
    ...
    onLoad() {
        ...
        function exposeFormatter() {
            DWEM.Modules.SpectatorModule.formatted_string_to_html = formatted_string_to_html;
        }
        ...
        function applySpectatorUI() {
            ...
            SpectatorModule.losDiameter = 7 * 2 + 1;
        }
        ...
        IOHook.handle_message.after.addHandler('spectator-module', (data) => {
            ...
            const formatter = SpectatorModule.formatted_string_to_html;
            if (data.msg === 'msgs' && data.messages && data.messages.length && formatter) {
                msgBar.innerHTML = formatter(data.messages[data.messages.length - 1].text);
            }
