...
export const BANNER_ASSETS = {
  ...
  secondAnniversaryGold: `${CNC_SECOND_ANNIVERSARY_ASSET_BASE}/five-pip-card-small-gold-champion-fill-animated.svg`,
  secondAnniversarySilver: `${CNC_SECOND_ANNIVERSARY_ASSET_BASE}/five-pip-card-small-silver-fill-bold-animated.svg`,
  secondAnniversaryBronze: `${CNC_SECOND_ANNIVERSARY_ASSET_BASE}/five-pip-card-small-bronze-fill-bold-animated.svg`,
  secondAnniversarySpecial: `${CNC_SECOND_ANNIVERSARY_ASSET_BASE}/five-pip-card-small-special-bold-animated.svg`,
